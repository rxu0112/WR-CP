...
def get_hours(date, roads):
    ...
    speed_path = os.path.join(project_path, "data\\seattle\\raw\\speed_matrix_2015")
    volume_path = os.path.join(project_path, "data\\seattle\\raw\\volume_total_matrix_2015")
    speed_dataset = pd.read_pickle(speed_path)
    volume_dataset = pd.read_pickle(volume_path)
...
pickle.dump(train_envs, open(project_path + "/data/seattle/processed/train_v" + str(ver), "wb"))
pickle.dump(test_envs_q, open(project_path + "/data/seattle/processed/test_v" + str(ver), "wb"))
np.save(project_path + '/data/seattle/processed/cal_uni_v' + str(ver) + '.npy', cal_envs_uni)