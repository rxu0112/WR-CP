...
if __name__ == "__main__":
    ...
    try:
        RESULT = pickle.load(open(project_path + "/hybrid/hybrid_result/" + flags.dataset + "/" + flags.version, "rb"))
    ...
    pickle.dump(RESULT, open(project_path + "/hybrid/hybrid_result/" + flags.dataset + "/" + flags.version, "wb"))
